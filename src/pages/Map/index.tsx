...
export function MapScreen() {
  ...
  return (
    <main className="flex min-h-screen flex-col bg-base-white text-base-black">
      <div className="sticky top-0 z-10 bg-base-white/80 backdrop-blur-sm">
        <div className="mx-auto max-w-4xl px-4 py-4">
          <div className="flex items-center rounded-lg bg-gray-100 p-2">
            <Search className="mr-2 h-5 w-5 text-gray-500" />
            <input type="text" placeholder="Buscar no mapa" className="w-full bg-transparent focus:outline-none" />
          </div>
          <div className="no-scrollbar mt-4 flex space-x-2 overflow-x-auto">
            {filters.map((filter) => {
