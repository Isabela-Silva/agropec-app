...
export const ActivitySchema = z.object({
  ...
  imageUrls: z.array(z.string().url('URL da imagem deve ser uma URL válida')).optional(),
...
export type ICreateActivityRequest = z.infer<typeof CreateActivityRequestSchema>;
